...
void loop() {
    ...
    Serial.println("7.Encrypt record in counter mode with AES + Serpent");
    Serial.println("8.Decrypt record in counter mode with AES + Serpent");
    Serial.println("9.Increment key (IV) n times");
    Serial.println("10.Encrypt record in counter mode with AES + Serpent + AES");
    Serial.println("11.Decrypt record in counter mode with AES + Serpent + AES");
    ...
    if(x == 5)
      m = 2;
    if(x == 6){
      Serial.print("Enter the massage to hash:");
      String input;
      while (!Serial.available()) {}
